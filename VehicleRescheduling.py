...
def train_agents(env, agents, n_episodes=30000, max_steps=300, viz_on = 0):
    rewards_per_episode = []
    deltas_arrival = []
...
def evaluate_agent(env, agent, n_eval_episodes=500, max_steps=300, q_table = None, viz_on = 0):
    rewards_per_episode = []
    deltas_arrival = []
...
agents = [QLearningAgent(env.total_states, 3, learning_rate=0.8, discount_factor=0.8, exploration_rate=0.8, exploration_decay=0.9995) for _ in env.trains]
...
agents_delayed = [QLearningAgent(env_delayed.total_states, 3, learning_rate=0.8, discount_factor=0.8, exploration_rate=0.8, exploration_decay=0.995) for _ in env_delayed.trains]
